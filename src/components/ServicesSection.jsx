      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div className="card">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRZFkDV-JWX5JeeeVeNpXPHidDrRM1yZqSBXA&usqp=CAU" className="card-img-top" alt="Best Quality" style={{ width: '100%', height: '200px' }} />
              <div className="card-body">
